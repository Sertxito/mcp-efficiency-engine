...
Documentación operativa y plantillas reutilizables sobre cómo montar especialización en GitHub Copilot mediante `.github/instructions` y `.github/prompts`.

**Nota**: Este es un boost meta-documental, no una solución independiente. Sirve como referencia para construir otros boosts.

### Key Features

- ✅ **Prompts Especializados** — Flujos de ejecución por dominio
- ✅ **Instrucciones Reutilizables** — Contratos operativos reutilizables
...
2. [Prompts Registry](.github/prompts/) — Catálogo completo
3. [Instructions Registry](.github/instructions/) — Especificaciones

### Crear Tu Primer Boost

```bash
# 1. Lee la template en .github/prompts/
