...
- [mcp-efficiency-engine](report-root-package-json.md) - Motor de orquestacion capability-centric v2 para agentes MCP con optimizacion always-on.
- [openwiki-internal-blueprint](report-autodocs-analysis-mcpee-openwiki-internal-blueprint-json.md) - Artefacto JSON de tipo report en autodocs/analysis_mcpee/openwiki-internal-blueprint.json.
- [telemetry-recovery-mcp-efficiency-engine-2026-08-08](report-autodocs-analysis-mcpee-telemetry-recovery-mcp-efficiency-engine-2026-08-08-json.md) - Artefacto JSON de tipo report en autodocs/analysis_mcpee/telemetry-recovery-mcp-efficiency-engine-2026-08-08.json.
