...
- total_pages: 9
- domains: documentation (5), autodocs (3), packaging (1)
...
- [AutoDocs Projection Engine](report-readme-wiki-md.md) - AutoDocs es una capacidad nativa de `mcp-efficiency-engine`. Toma conocimiento estructurado de artefactos existentes en `repo-intake/generated/`,
- [File Index](report-file-index-md.md) - Indice del contenido y estructura del repositorio.
