...
6. El trabajo operativo de esta plataforma se gestiona desde la raiz del
   repositorio.
7. Todo artefacto de analisis/trazabilidad debe guardarse en
   `autodocs/analysis_mcpee/` y los artefactos generados en
   `autodocs/generated/`, salvo artefactos globales de plataforma expresamente
   definidos.
